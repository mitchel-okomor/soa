    ...
    <div className="row">
      ...
      <div className="col-sm-11  goal">
        <p>
          ...
          small group of Africans want to educate the world with stories about
          Africa mythology.
        </p>
        <h3>
          <b>Goals:</b>
        ...
        <p>
          ...
          beautiful untold and poorly expressed stories about Africa and African
          myth, that's our inspiration at SoA. We want to be a source of hope to
          the African Community, helping people all over the world understand
          and enjoy Africa by making sure that l the world gets to know more
          about the true African stories, how it happened, when it happened and
          where it happened.
        </p>
        <p>
